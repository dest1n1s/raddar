...
/// A trait for a tensor-like object that can perform advanced linear algebra operations.
///
...
pub trait TensorLinear: TensorOps {
...
/// A trait for a tensor-like object that can perform operations related to statistics.
pub trait TensorStatistics: TensorOps {
...
impl TensorStatistics for Tensor {
    fn bernoulli(&self) -> Self {
        self.bernoulli()
    }
}